// faqData.js - Datos de Preguntas Frecuentes
// Este archivo puede ser fácilmente reemplazado por una llamada a BD en el futuro
...
// Función helper para obtener preguntas destacadas
export const getFeaturedFAQs = () => {
  return faqData.filter(item => item.featured === true);
};
